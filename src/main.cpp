...
int main()
{
    ...
    Shader screenQuad("E://cpp_review//capstone_sdust//gpu_ray_tracing//src//screenQuad.vs", "E://cpp_review//capstone_sdust//gpu_ray_tracing//src//screenQuad.fs");
    Shader computeShader("E://cpp_review//capstone_sdust//gpu_ray_tracing//src//computeShader.comp");
